...
public class HashMap1_BasicTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("1. put() 메소드를 이용한 요소 저장");
		map.put("Apple", 3);
		map.put("Banana", 2);
		map.put("Orange", 1);
		map.put("Blueberry", 7);
		...
		System.out.println("2. remove() 메소드를 이용한 요소 제거 (*제거하면서 값 반환)");
		...
		System.out.println("3. remove() 메소드를 이용한 요소 제거 (*기존 값을 올바르게 입력할 경우 가능)");
		System.out.println("'Peach'키 값 2로 제거 가능한가? " + map.remove("Peach", 2));
		System.out.println("'Peach'키 값 4로 제거 가능한가? " + map.remove("Peach", 4));
		System.out.println();
		printMap(map);
		
		System.out.println("4. keySet() 메소드를 이용한 키로 구성된 Set 객체 반환");
		System.out.println(map.keySet());
		System.out.println();
		
		System.out.println("5. size() 메소드를 이용한 요소의 총 개수");
		System.out.println("Map의 크기 : " + map.size());
		System.out.println();
		
		System.out.println("6. get() 메소드를 이용하여 키에 대응하는 값 반환");
		...
		System.out.println("7. replace() 메소드를 이용하여 키에 대응하는 값 변환");
		...
		System.out.println("8. replace() 메소드를 이용하여 키에 대응하는 값 변환 (*기존 값을 올바르게 입력할 경우 가능)");
		System.out.println();
		...
		System.out.println("9. containsKey() 메소드를 이용한 특정 키 포함 여부 확인");
